...
public class MobRegistryPatch {
    ...
    static void onExit() {
        ...
        MobRegistry.registerMob("honeybee", HoneyBeeMob.class, true, false, new LocalMessage("item", "honeybee"), (GameMessage)null);
        ...
        MobRegistry.registerMob("stonecaveling", StoneCaveling.class, true, false, (GameMessage)null);
        MobRegistry.registerMob("snowstonecaveling", SnowStoneCaveling.class, true, false, (GameMessage)null);
        MobRegistry.registerMob("swampstonecaveling", SwampStoneCaveling.class, true, false, (GameMessage)null);
        MobRegistry.registerMob("sandstonecaveling", SandStoneCaveling.class, true, false, (GameMessage)null);
        MobRegistry.registerMob("deepstonecaveling", DeepStoneCaveling.class, true, false, (GameMessage)null);
        MobRegistry.registerMob("deepsnowstonecaveling", DeepSnowStoneCaveling.class, true, false, (GameMessage)null);
        MobRegistry.registerMob("deepswampstonecaveling", DeepSwampStoneCaveling.class, true, false, (GameMessage)null);
        MobRegistry.registerMob("deepsandstonecaveling", DeepSandStoneCaveling.class, true, false, (GameMessage)null);
        MobRegistry.registerMob("flameling", Flameling.class, true, false, (GameMessage)null);
        ...
        MobRegistry.registerMob("crystaldragonbody", CrystalDragonBody.class, true, true);
        ...
        MobRegistry.registerMob("trainingdummy", TrainingDummyMob.class, false, false, new LocalMessage("object", "trainingdummy"), (GameMessage)null);
