...
public class InspectionTable2Object extends CraftingStationObject {
    private GameTexture texture;
    protected int counterID;

    protected InspectionTable2Object() {
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = GameTexture.fromFile("objects/inspectiontable");
    }
